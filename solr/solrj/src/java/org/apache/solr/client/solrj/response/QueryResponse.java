...
public class QueryResponse extends SolrResponseBase 
{
  ...
  protected List<PivotField> readPivots( List<NamedList> list )
  {
    ...
    for( NamedList nl : list ) {
      ...
      String f = (String)nl.get("field");
      Object v = nl.get("value");
      int cnt = ((Integer)nl.get("count")).intValue();
      
      NamedList<Object> stats = null;
      Object o = nl.get("statistics");
      if (o != null) {
         stats = (NamedList<Object>)o;
      }
      
      List<PivotField> p = null;
      o = nl.get("pivot");
      if (o != null) {
         p = readPivots((List<NamedList>)o);
      }
      
      Long distinct = null;
      o = nl.get("distinct");
      if (o != null) {
        distinct = ((Long)o).longValue();
      }
      
      values.add( new PivotField( f, v, cnt, p, stats, distinct ) );
    }
    return values;
  }

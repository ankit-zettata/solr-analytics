...
public interface FacetParams {
  ...
  /**
   * Returns pivot distinct values only to allow for a person to get
   * the "group" of a query.
   */
  public static final String FACET_PIVOT_DISTINCT = FACET_PIVOT + ".distinct";
 ...
 /**
  ...
  public static final String PERCENTILE = "percentiles";
  public static final String PERCENTILE_FIELD = PERCENTILE + ".field";
  public static final String PERCENTILE_REQUESTED_PERCENTILES = PERCENTILE + ".requested.percentiles";
  public static final String PERCENTILE_LOWER_FENCE = PERCENTILE + ".lower.fence";
  public static final String PERCENTILE_UPPER_FENCE = PERCENTILE + ".upper.fence";
  public static final String PERCENTILE_GAP = PERCENTILE + ".gap";
  public static final String PERCENTILE_DISTRIBUTED = PERCENTILE + ".distributed";
  public static final String PERCENTILE_BUCKETS = PERCENTILE + "_buckets";
  public static final String PERCENTILE_SHARD_TOTAL_COUNT = PERCENTILE_BUCKETS + "_total_count";
  public static final String PERCENTILE_AVERAGES = PERCENTILE + ".averages";
